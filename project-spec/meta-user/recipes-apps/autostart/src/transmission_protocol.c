...
void entropy_to_gmm(int16_t *entropy_addr, gmm_t *gmm, size_t len) {
  for (size_t i = 0; i < len; i += 9) {
    gmm[i].mean1 = entropy_addr[i];
    gmm[i].mean2 = entropy_addr[i + 1];
    gmm[i].mean3 = entropy_addr[i + 2];
    gmm[i].std1 = entropy_addr[i + 3];
    gmm[i].std2 = entropy_addr[i + 4];
    gmm[i].std3 = entropy_addr[i + 5];
    gmm[i].prob1 = entropy_addr[i + 6];
    gmm[i].prob2 = entropy_addr[i + 7];
    gmm[i].prob3 = entropy_addr[i + 8];
  }
}
