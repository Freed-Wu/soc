 ...
 * @return int 
 */
int axitangxi_data_init(axitangxi_dev_t dev, size_t tx_size, size_t rx_size, uint32_t *tx_buf, uint32_t *rx_buf)
{
    ...
    printf("tx_data_ps_addr: 0x%x \nrx_data_ps_addr: 0x%x\ntx_data_pl_addr: 0x%x \nrx_data_pl_addr: 0x%x\n",
    		(uintptr_t) dev->tx_data_ps_ptr, (uintptr_t) dev->rx_data_ps_ptr, dev->tx_data_pl_ptr, dev->rx_data_pl_ptr);
 ...
 * @return int
 */
int ps_to_pl_data_init(axitangxi_dev_t dev, size_t tx_size, size_t rx_size, uint32_t *tx_buf, uint32_t rx_buf)
{
 ...
 * @return int
 */
int pl_to_ps_data_init(axitangxi_dev_t dev, size_t tx_size, size_t rx_size, uint32_t tx_buf, uint32_t *rx_buf)
{
...
int network_acc_data_init(network_acc_dev_t dev)
{
    ...
    printf("weight_addr: 0x%x \n weight_size: 0x%x\n quantify_addr: 0x%x \n quantify_size: 0x%x\n ",
            dev->weight_addr, dev->weight_size, dev->quantify_addr, dev->quantify_size);
...
int acc_config_test(network_acc_dev_t dev)
{
 ...
 int acc_get_test(network_acc_dev_t dev)
 {
     ...
     printf("trans_addr: 0x%x \n trans_size: 0x%x\n entropy_addr: 0x%x \n entropy_size: 0x%x\n ",
             dev->trans_addr, dev->trans_size, dev->entropy_addr, dev->entropy_size);
